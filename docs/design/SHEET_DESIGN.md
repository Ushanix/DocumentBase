...
| # | column | type | description |
|---|--------|------|-------------|
| 16 | document_id | string | 導出値: Series ID + doc_type接頭辞 + 種別内通番 → `MAN-DEV-01-M01` |
...
| doc_type | prefix | 例 |
|----------|--------|----|
| manual | M | MAN-DEV-01-M01 |
| procedure | P | MAN-DEV-01-P01 |
| checklist | C | MAN-DEV-01-C01 |
| requirements | R | MAN-DEV-01-R01 |
| design | D | MAN-DEV-01-D01 |
| template | T | MAN-DEV-01-T01 |
| knowledge | K | MAN-DEV-01-K01 |
| reference | RF | REF-NW-01-RF01 |
| master | MS | REF-NW-01-MS01 |
| readme | RM | REF-NW-01-RM01 |
| index | IX | REF-NW-01-IX01 |
| dashboard | DB | REF-NW-01-DB01 |
...
|----|----------|------------|-------------|
| 1 | manual | 1 | MAN-DEV-01-M01 |
| 2 | checklist | 1 | MAN-DEV-01-C01 |
| 3 | manual | 2 | MAN-DEV-01-M02 |
| 4 | procedure | 1 | MAN-DEV-01-P01 |
...
例: `MAN-DEV-01-M01_v1.1_Git運用手引書.md`
...
series_id:    MAN-DEV-01
file_name:    MAN-DEV-01-S01_v1.1_Git運用手引書.md

→ D:\ObsidianVault\40_DocumentBase\MAN-DEV-01\MAN-DEV-01-S01_v1.1_Git運用手引書.md
```
